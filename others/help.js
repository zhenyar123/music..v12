  ...
  async execute(message,args,client) {
    ...
    let helpEmbed = new MessageEmbed()
      ...
      .setDescription("__**```List of all commands```**__")
       ...
       .setDescription(`**[  SUPPORT  ](https://discord.gg/jcs4XwcExv)**   -  [   INVITE   ](https://discord.com/api/oauth2/authorize?client_id=806840212608909344&permissions=70346817&scope=bot)`)
